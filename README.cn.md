...
![shadowsocks-rust](https://repo.x-cmd.io/shadowsocks-rust.svg?lang=zh)
...
合计: **94,082** 行代码（覆盖前 5 种语言、共 **241** 个文件）。
...
- **上游仓库**: <https://github.com/shadowsocks/shadowsocks-rust>
- **官网**: <https://shadowsocks.org/>
- **许可证**: MIT

## 发布

- **最新版本**: `v1.25.0` (2026-08-26)
- **最近提交**: 2026-09-11
- **Release 含资产**: 52 个

## 流行度

- **Star**: 10,856 · **Fork**: 1,449 · **开放 issue**: 894 · **贡献者**: 111

## 累计统计

- **发布数**: 162 · **已合并 PR**: 928 · **开放 PR**: 5 · **已关闭 issue**: 835 · **开放 issue**: 59 · **提交数**: 3442

## 最近活动

| 时间窗口 | 起始 | 发布 | 已合并 PR | 开放 PR | 已关闭 issue | 开放 issue | 提交 |
|---|---|---:|---:|---:|---:|---:|---:|
| 30d | 2026-08-12 | 1 | 6 | 1 | 1 | 1 | 22 |
| last60d | 2026-07-13 | 1 | 12 | 2 | 1 | 3 | 57 |
| 90d | 2026-06-13 | 1 | 22 | 2 | 1 | 3 | 84 |
| last180d | 2026-03-15 | 1 | 57 | 3 | 7 | 5 | 180 |
| 360d | 2025-09-16 | 2 | 100 | 3 | 21 | 10 | 324 |
| last720d | 2024-09-21 | 12 | 348 | 3 | 79 | 31 | 836 |
...
- **编辑包条目**: <https://github.com/x-cmd/install/edit/main/shadowsocks-rust.yml>（或索引实际使用的路径）

本页面的数据（card / loc / scorecard / release）由 [x-cmd-install-action](https://github.com/x-cmd-install/x-cmd-install-action) 自动采集，每日重新生成。**安装行为**（版本选择、平台差异、依赖处理）的改进应提交到上游索引。

_数据快照: `data/card/260911.yml` · 2026-09-11T19:29:09Z._
